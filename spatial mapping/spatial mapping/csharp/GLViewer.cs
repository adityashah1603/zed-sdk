    ...
    class SpatialMappingObject {
        ...
        public void update(Chunk chunk) {
            ...
            if (chunk.vertices.Count() > 0) {
                ...
                Gl.BufferData(
                    ...
                    (uint)chunk.vertices.Count() * sizeof(float) * 3,
                    chunk.vertices.ToArray(),
            ...
            if (chunk.triangles.Count() > 0) {
                ...
                Gl.BufferData(
                    ...
                    (uint)chunk.triangles.Count() * sizeof(int),
                    chunk.triangles.ToArray(),
                    BufferUsage.DynamicDraw
                );
        ...
        public void draw(bool draw_mesh) {
            if (current_fc != 0 && vaoID_ != 0) {
                Gl.BindVertexArray(vaoID_);
                Gl.DrawElements(
                    draw_mesh == true ? PrimitiveType.Triangles : PrimitiveType.Points,
                    current_fc,
