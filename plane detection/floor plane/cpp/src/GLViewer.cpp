...
void GLViewer::printText() {
    ...
    std::string _str
        = floorFind ? std::string("FLOOR PLANE FOUND, WORLD REFERENCE IS SET") : std::string("LOOKING FOR FLOOR PLANE, move around");
...
bool ImageHandler::initialize(sl::Resolution res) {
    ...
    glGenBuffers(3, vboID_);
    {
        ...
        static const GLfloat g_quad_vertex_buffer_data[] = {w_0, h_0, w_1, h_0, w_0, h_1, w_1, h_1};
...

    {
        ...
        static const GLfloat g_quad_vertex_buffer_data[] = {w_0, h_0, 0.f, w_1, h_0, 0.f, w_0, h_1, 0.f, w_1, h_1, 0.f};
        glBindBuffer(GL_ARRAY_BUFFER, vboID_[1]);
